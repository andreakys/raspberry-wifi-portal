...
export PORTAL_TITLE="${PORTAL_TITLE:-VT Network Manager}"
export NETWORK_STATUS_TCP_ENABLED="${NETWORK_STATUS_TCP_ENABLED:-true}"
export NETWORK_STATUS_TCP_PORT="${NETWORK_STATUS_TCP_PORT:-6001}"
export NETWORK_STATUS_TCP_INTERVAL_SECONDS="${NETWORK_STATUS_TCP_INTERVAL_SECONDS:-30}"
